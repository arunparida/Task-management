...
const createTask = async (req, res) => {
  try {
      ...
      return res
        ...
        .json(
          new ApiResponse(
            400,
            null,
            "Title, description, priority, and status are required"
          )
        );
    }
    ...
    return res
      .status(201)
      .json(
        new ApiResponse(201, { task: newTask }, "Task created successfully")
      );
  } catch (error) {
...
const getAllTasks = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { tasks: tasks }, "Internal Server Error"));
  } catch (error) {
...
const getTasksData = async (req, res) => {
  try {
    ...
    // Admins see all tasks
      ...
      return res
        .status(403)
        .json(new ApiResponse(403, null, "Invalid role for viewing tasks."));
    }
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, data, "Task data fetched successfully"));
  } catch (error) {
